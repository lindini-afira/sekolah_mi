			...
			<div class="container">
				...
				<div class="box">
                    ...
                    <form action="" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            <label>Favicon</label>
                            <img src="../uploads/identitas/<?= $d->favicon ?>" width="200px" class="image">
                            <input type="hidden" name="favicon_lama" value="<?= $d->favicon ?>">
                            <input type="file" name="favicon_baru" class="input-control">
                        </div>

                        <input type="submit" name="submit" value="Simpan Perubahan" class="btn btn-red">
						...
						if(isset($_POST['submit'])){
                            ...
                            if($_FILES['logo_baru']['name'] != ''){
                                ...
                                $filsize_logo        = $_FILES['logo_baru']['size'];

                                $formatfile_logo     = pathinfo($filename, PATHINFO_EXTENSION);
